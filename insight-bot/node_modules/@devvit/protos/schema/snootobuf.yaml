...
remote_sources:
  ...
  - git: github.snooguts.net/reddit/devplatform-api/api/proto/devvit/dev_portal@v1.9.6 # for local development

dependencies:
  # production; this should probably be kept in sync with the identical
  # dependency in remote sources above? you probably want to upgrade the
  # dependency in devvit-compute-go/go.mod, go-common/go.mod, and
  # devvit-gateway-service/go.mod too.
  - git: github.snooguts.net/reddit/devplatform-api/api/proto@v1.9.6
